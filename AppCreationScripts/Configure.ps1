...
#> 
   ...
   $dictionary = @{ "Enter_the_Tenant_Info_Here" = $tenantId;"Enter_the_Application_Id_Here" = $clientAadApplication.AppId;"Enter_the_Redirect_Uri_Here" = $clientAadApplication.ReplyUrls;"Enter_the_Cloud_Instance_Id_Here" = 'https://login.microsoftonline.com/';"Enter_the_Graph_Endpoint_Here" = 'https://graph.microsoft.com/' };
